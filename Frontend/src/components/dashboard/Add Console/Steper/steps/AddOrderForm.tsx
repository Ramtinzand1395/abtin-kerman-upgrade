import { MdClose, MdPriceChange } from "react-icons/md";
  ...
  return (
    <>
      <div className="grid md:grid-cols-3 grid-cols-1 gap-5">
        ...
        <div className={wrapperClasses}>
          ...
          <div className={iconClasses}>
            <MdPriceChange size={20} color="gray" />
          </div>
        </div>
        ...
        <div className={wrapperClasses}>
          ...
          <div className={iconClasses}>
            <GiConsoleController size={20} color="gray" />
          </div>
        </div>
      ...
      <div className={`${wrapperClasses} mt-5`}>
        ...
        >
          {loadingAddCustomer ? <Spiner /> : " ثبت سفارش"}
        </button>
      </div>
    </>
  );
